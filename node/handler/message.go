...
// Message processes a message from the network..
func Message(log zerolog.Logger, wg *sync.WaitGroup, net Network, paths Paths, downloads Downloads, headers Headers, inventories Inventories, transactions Transactions, peers Peers, handleEntity func(types.Entity)) func(string, interface{}) {
	return func(address string, input interface{}) {
		defer wg.Done()
